...
require("../../assets/style/pdf_viewer.css");

require("../../assets/style/PdfAnnotator.css");

var _getBoundingRect = require("../../assets/lib/get-bounding-rect");

var _getBoundingRect2 = _interopRequireDefault(_getBoundingRect);

var _getClientRects = require("../../assets/lib/get-client-rects");

var _getClientRects2 = _interopRequireDefault(_getClientRects);

var _getAreaAsPng = require("../../assets/lib/get-area-as-png");

var _getAreaAsPng2 = _interopRequireDefault(_getAreaAsPng);

var _pdfjsDom = require("../../assets/lib/pdfjs-dom");

 var _TextLayerBuilder_bindMouse = require("../../assets/PDFJS/TextLayerBuilder_bindMouse");
...
var _coordinates = require("../../assets/lib/coordinates");
