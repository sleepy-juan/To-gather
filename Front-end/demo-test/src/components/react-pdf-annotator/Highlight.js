...
require("../../assets/style/Highlight.css");
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        rects.map(function (rect, index) {
           var cls ="";
           if(comment!==undefined && comment.text!==undefined){
         if(comment.text.includes("ICD"))
         {
            cls= "Highlight__partBlue"
         }
         else if(comment.text.includes("HCC"))
         {
           cls= "Highlight__partGreen"
         }
          else if(comment.text.includes("RX"))
         {
           cls= "Highlight__partRed"
         }
         else{
            cls= "Highlight__part"
         }
